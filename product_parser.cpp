...
Product* ProductBookParser::parseSpecificProduct(
        std::string category, std::istream& is, bool& error, std::string& errorMsg, int& lineno) {
    string myline;
    getline(is, myline);
...
std::string ProductBookParser::categoryID() { return "book"; }
...
Product* ProductBookParser::makeProduct() {
    ...
    Book* mybook = new Book(prodName_, price_, qty_, isbn_, author_);
...
Product* ProductClothingParser::parseSpecificProduct(
        std::string category, std::istream& is, bool& error, std::string& errorMsg, int& lineno) {
    string myline;
    getline(is, myline);
    stringstream ss3(myline);
...
std::string ProductClothingParser::categoryID() { return "clothing"; }
...
Product* ProductClothingParser::makeProduct() {
    ...
    Clothing* myclothing = new Clothing(prodName_, price_, qty_, size_, brand_);
...
Product* ProductMovieParser::parseSpecificProduct(
        std::string category, std::istream& is, bool& error, std::string& errorMsg, int& lineno) {
    string myline;
    getline(is, myline);
    stringstream ss3(myline);
...
std::string ProductMovieParser::categoryID() { return "movie"; }
...
Product* ProductMovieParser::makeProduct() {
    ...
    Movie* mymovie = new Movie(prodName_, price_, qty_, genre_, rating_);
